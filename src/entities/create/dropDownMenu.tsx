    ...
    return (
        <Accordion type="multiple" collapsible defaultValue="shipping" className="max-w-70 w-full">
            <AccordionItem value="returns" className="pb-5">
                <AccordionTrigger className="text-lg">{t("setting.accessibility")}</AccordionTrigger>
                <AccordionContent className="flex flex-col gap-3">
                    <Typography sx={{ color: "#A8A8A8" }} variant="body2">{t("accessibility_info")}</Typography>
            ...
            <AccordionContent className="flex flex-col items-center gap-3 py-3 px-2 pb-5">
              ...
              <p className="text-[#6A717A] dark:text-[#A8A8A8]">{t("likes_views_info")}<span className="text-[#708DFF] cursor-pointer hover:underline" onClick={()=>router.push("https://help.instagram.com/113355287252104")}>{t("authentication.register.contactInfoMore")}</span></p>
            </AccordionContent>
