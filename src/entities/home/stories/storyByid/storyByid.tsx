...
function StoryByid({
  ...
  const handleShareStory = (story: string) => {
    setShareStory(true)
    setStory(story)
  }
              ...
              */}
                ...
                ))}
              {
                <div className="absolute bottom-[0px] z-[200] w-[100%] px-[27px] py-[16px] flex items-center gap-4 bg-gradient-to-t from-black/60 to-transparent">
                  ...
                  <svg aria-label="Direct" className="duration-200 hover:scale-110 text-white cursor-pointer" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24" onClick={()=>handleShareStory(currentStory.fileName)}>
                    <title>Direct</title>
